      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">
            Submit a Deal or{" "}
            <span className="gold-gradient">Connect With Us</span>
          </h2>
          <p className="max-w-2xl mx-auto text-gray-400 text-lg leading-relaxed">
            Whether you have a qualified deal, want to learn more about our
            strategy, or are looking to build a long-term partnership — we
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          ...
          >
            <div>
              ...
              <p className="text-yellow-500 text-sm italic mb-4">
                Transforming Property Into Possibilities
              </p>
              <p className="text-gray-400 text-sm leading-relaxed">
                We are active acquirers looking for the right deals and the
                right partners. If you have a property that fits our buy box,
                let's connect.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300 text-sm">Available upon inquiry</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
            ...
            {submitted ? (
              <div className="bg-[#0f0f0f] border border-yellow-900/40 rounded-2xl p-12 text-center">
                ...
                <p className="text-gray-400 text-sm leading-relaxed max-w-sm mx-auto">
                  Thank you for reaching out. A member of the Marss Real Estate
                  team will respond to your inquiry within 48 hours.
                </p>
              </div>
            ) : (
              <form
                onSubmit={handleSubmit}
                className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-2xl p-8 space-y-5"
              >
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={(v) => handleChange("propertyType", v)}>
                      <SelectTrigger className="bg-[#151515] border-[#252525] text-white focus:border-yellow-500/50">
                ...
                <div className="space-y-2">
                  <Label className="text-gray-300 text-sm">
                    Tell Us About the Deal / Inquiry *
                  </Label>
                  <Textarea
                    required
                    value={form.message}
                    onChange={(e) => handleChange("message", e.target.value)}
                    placeholder="Property address, unit count, current situation, asking price, timeline..."
                    rows={4}
                ...
                <p className="text-gray-600 text-xs text-center">
                  By submitting, you agree to be contacted by Marss Real Estate
