    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-invert prose-yellow max-w-none space-y-10 text-gray-300">
        ...
        <section>
          ...
          <p className="leading-relaxed mb-4">When a buyer depends entirely on outside financing to acquire your business, the certainty of your sale is only as strong as that financing. A third-party lender can control the timeline and underwriting, and fully negotiated deals under contract sometimes collapse weeks later because:</p>
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-start gap-2"><span className="text-yellow-500 mt-1 shrink-0">&#x2022;</span>A third-party valuation comes in below the negotiated price</li>
            <li className="flex items-start gap-2"><span className="text-yellow-500 mt-1 shrink-0">&#x2022;</span>The financing terms change mid-process</li>
            ...
            <li className="flex items-start gap-2"><span className="text-yellow-500 mt-1 shrink-0">&#x2022;</span>New conditions are added that the seller won&apos;t accept</li>
          </ul>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="border border-[#1f1f1f] bg-[#0d0d0d] rounded-xl p-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">Marss brings a senior financing layer at a conservative loan-to-value ratio. This provides immediate liquidity at close for both parties and establishes institutional-grade underwriting on the deal. The senior lender holds the first-position secured interest.</p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-3">
            <p className="text-gray-400 leading-relaxed"><strong className="text-white">Best for:</strong> Sellers who want full or near-full asking price, don&apos;t want to accept a forced discount from traditional financing constraints, and are willing to receive a portion of proceeds over a documented 3–10 year schedule.</p>
