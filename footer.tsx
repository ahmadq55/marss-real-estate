      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-5 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-xs">
              A real estate and business acquisition firm actively acquiring
              commercial real estate and essential operating businesses across
              the Sunbelt — with multiple structures to close on your terms.
            </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs">
            © {new Date().getFullYear()} Marss Real Estate. All rights reserved. · Frisco, Texas
          </p>
          <p className="text-gray-700 text-xs">
            Sellers · Brokers · Investors · Advisory Partners
          </p>
        </div>
      </div>
    </footer>
